...
import { FaArrowRight, FaLocationDot, FaStore } from "react-icons/fa6";
    ...
    <div className="min-h-screen bg-gray-200">
      ...
      {shop && (
        <div className="relative w-full h-64 md:h-80 lg:h-96">
          <img src={shop.image} alt="" className="object-cover h-full w-full" />
          <div
            className="absolute inset-0 bg-gradient-to-b from-black/70 to-blue-30 flex flex-col justify-center items-center text-center px-4
        "
          >
