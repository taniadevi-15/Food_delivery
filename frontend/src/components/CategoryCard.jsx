...
const CategoryCard = ({name,image,onClick}) => {
  return (
    <div className='w-[120px] h-[120px] md:w-[180px] md:h-[180px] rounded-xl
    ...
    onClick={onClick}>
        ...
        w-full h-full object-cover transform hover:scale-110 transition-transform 
        duration-300 '/>
        <div className='absolute bottom-0 w-full left-0 bg-[#ffffff96]
        bg-opacity-95 px-3 py-1 rounded-t-xl text-center shadow
